...
3. **Zero-Shot LLM (openai/gpt-oss-120b)**: The clear winner. It achieved an astounding **0.97** Macro-F1 on completely unseen merchants by reasoning about the merchant name contextually.
